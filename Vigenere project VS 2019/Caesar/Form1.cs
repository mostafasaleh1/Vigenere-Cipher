...
namespace Caesar
{
    public partial class Form1 : Form
    {
        ...
        private void ComboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (comboBox1.Text == "I want to Encrypt text with Vigenere") // When this choice is chosen, button 1 will appear, button 2 will disappear, and text on labels 3 and 4 will be changed as shown
            {
            ...
            else if(comboBox1.Text == "I want to Decrypt text with Vigenere") // When this choice is chosen, button 1 will disappear, button 2 will appear, and text on labels 3 and 4 will be changed as shown
            {
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string key = textBox1.Text; // convert the key into an integer
                            for (int i = 0; ; i++)
                            {
                                ...
                                if (key.Length == textBox2.Text.Length)
                                {
                                    break;
                                }
                                key += (key[i]);
                            }
                            string EncryptedText = "";// declare  empty string.
                            ...
                            for (int i = 0; i < textBox2.Text.Length; i++)
                            {
                                if (char.IsLetter(textBox2.Text[i])) // if input text is consisted of letters, do the following.
                                {
                                    ...
                                    {
                                        EncryptedText += (char)((((textBox2.Text[i] - 32) + key[i]) % 26) + 65); // encryption equation for small letters + concatinate each encrypted (shifted) letter to the variable EncryptedText
                                    }
                                    else // if the letters aren't small, then it's capital, and do the following
                                    {
                                        EncryptedText += (char)(((textBox2.Text[i] + key[i]) % 26) + 65);// encryption equation for capital letters + concatinate each encrypted (shifted) letter to the variable EncryptedText
                                    }
                                }
            ...
            try
            {
                if (textBox1.Text != "" || textBox1.Text == null) // if the user entered a key without errors do the following code
                {
                    string key = textBox1.Text;
                            for (int i = 0; ; i++)
                            {
                                if (textBox3.Text.Length == i)
                                {
                                    i = 0;
                                }
                                if (key.Length == textBox3.Text.Length)
                                {
                                    break;
                                }
                                key += (key[i]);
                            }
                            string DecryptedText = ""; // declare an empty string.
                            ...
                            for (int i = 0; i < textBox3.Text.Length && i < key.Length; i++)
                            {
                                if (char.IsLetter(textBox3.Text[i])) // if input text is consisted of letters, do the following.
                                {
                                    ...
                                    {
                                        DecryptedText += (char)((((textBox3.Text[i] - 32) - key[i] + 26) % 26) + 65); // Decryption equation for small letters + concatinate each Decrypted (shifted) letter to the variable EncryptedText
                                    }
                                    else // if the letters aren't small, then it's capital, and do the following
                                    {
                                        DecryptedText += (char)(((textBox3.Text[i] - key[i] + 26) % 26) + 65); // Decryption equation for capital letters + concatinate each Decrypted (shifted) letter to the variable EncryptedText
                                    }
                                }
                                else // if input text is not consisted of letters, do the following.
                                {
                                    DecryptedText += textBox3.Text[i]; // concatinate each non-letter symbol as it is to the resulting text
                                }
                            }
                            textBox2.Text = DecryptedText; // put the final result in the text box 2
                }
                else // if the user didn't enter a key print this message box
                {
                    MessageBox.Show("Error: You must enter a key");
